...
configure_build () {
  ...
  cmake -DCMAKE_INSTALL_PREFIX:PATH=$3 -DCONFIG_RUNTIME_CPU_DETECT=no  \
        -DENABLE_NEON=ON -DHAVE_NEON=1 -DCONFIG_AV1_HIGHBITDEPTH=YES \
        -DENABLE_EXAMPLES=OFF -DCMAKE_BUILD_TYPE=Release \
        -DCMAKE_CXX_FLAGS="-flto -O3" -DCMAKE_C_FLAGS="-flto -O3" -DCMAKE_C_FLAGS_INIT="-flto=8" ../aom/
